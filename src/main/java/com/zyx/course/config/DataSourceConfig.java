...
import com.zyx.course.config.bean.DataSourceVo;
...
@Configuration
@MapperScan(basePackages = {"com.zyx.course.mapper"},sqlSessionFactoryRef = "sqlSessionFactory")
public class DataSourceConfig {
    ...
    public DruidDataSource dataSource() throws Exception{
        ...
        dataSource.setUrl("jdbc:mysql://127.0.0.1:3306/coursesystem?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true");

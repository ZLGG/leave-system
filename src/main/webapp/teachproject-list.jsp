...
<html class="x-admin-sm">
  ...
  <script type="text/html" id="barDemo">
    ...
    <%--<c:choose>
     ...
     <a class="layui-btn layui-btn-xs" lay-event="edit"><i class="layui-icon">及格</i></a>
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del"><i class="layui-icon">不及格</i></a>
  </script>
    <div class="x-nav">
    ...
    <div class="x-body">
      <table class="layui-table" lay-data="{url:'/selectTeacherProject',page:true,id:'test'}" lay-filter="test">
        <thead>
          <tr>
            <th lay-data="{type:'checkbox'}">ID</th>
            <th lay-data="{field:'id', width:80, sort: true}">ID</th>
            <th lay-data="{field:'project', width:120, sort: true}">课程</th>
            <th lay-data="{field:'userName', width:120, sort: true}">学生</th>
            <%--<th lay-data="{field:'userName', minWidth: 80, width:220}">授课教师</th>--%>
            <th lay-data="{field:'score', width:80 }">学分</th>
            <th lay-data="{field:'ispassName', width:80 }">成绩</th>

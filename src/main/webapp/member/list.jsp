	...
	<body>
		...
		<div class="weadmin-body">
			...
			<div class="weadmin-block">
				...
				<button class="layui-btn" onclick="WeAdminShow('添加用户','/test/member/add',600,400)"><i class="layui-icon"></i>添加</button>
				...
				<tbody>
					<tr data-id="1">
						...
						<td class="td-manage">
							...
							<a onclick="WeAdminShow('修改密码','/test/password',600,400)" title="修改密码" href="javascript:;">
								<i class="layui-icon">&#xe631;</i>
							</a>

...
<div class="x-body">
    ...
    <table class="layui-table" lay-data="{url:'/getStudentList',page:true,toolbar: 'default',id:'test'}" lay-filter="test">
        <thead>
        <tr>
            <th lay-data="{type:'checkbox'}">ID</th>
            <th lay-data="{field:'id', width:80, sort: true}">ID</th>
            <th lay-data="{field:'number', width:120, sort: true}">学号</th>
            <th lay-data="{field:'userName', width:120, sort: true, edit: 'text'}">用户名</th>
            <th lay-data="{field:'college', minWidth: 100, width:100}">学院</th>
             <th lay-data="{field:'clas', width:80, sort: true, edit: 'text'}">班级</th>
